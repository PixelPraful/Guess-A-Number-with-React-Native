...
const Game = props => {
  ...
  const [pastGuess, setPassGuess] = useState([initialGuess.toString()]);
  ...
  const nextGuessHandler = direction => {
    ...
    setPassGuess(curPastGuess => [nextNumber.toString(), ...curPastGuess]);
    // setRounds(curRounds => curRounds + 1);
  }

  return (
    <View style={styles.screen}>
      <Text style={DefaultStyle.title}>Computer's Guess</Text>
